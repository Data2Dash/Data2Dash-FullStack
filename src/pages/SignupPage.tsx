        ...
        <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4 py-16">
            <div className="w-full max-w-sm">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-stone-500 text-sm">Start your research journey</p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-stone-200 shadow-soft p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        <div>
                            <label className="block text-xs font-medium text-stone-600 mb-1.5">Full name <span className="text-stone-400">(optional)</span></label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full h-10 rounded-xl border border-stone-200 bg-white pl-9 pr-4 text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-stone-400 transition-all"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full h-10 rounded-xl border border-stone-200 bg-white pl-9 pr-10 text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-stone-400 transition-all"
