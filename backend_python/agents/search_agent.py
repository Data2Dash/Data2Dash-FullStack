...
class SearchAgent:
    def __init__(self, groq_api_key: str = None):
        # Allow passing api_key or get from environment
        if not groq_api_key:
        ...
        self.tools = {
            "Wikipedia": {
                "tool": self.wiki,
                "description": "Good for factual information, background knowledge, and general concepts."
            },
            "Arxiv": {
                "tool": self.arxiv,
                "description": "Good for scientific papers, latest research, and technical details."
            },
            "Search": {
                "tool": self.search,
                "description": "Good for current events, news, or general web search."
            }
        }
